...
export default function ExperienceScreen() {
  ...
  const options: Option[] = [
    { icon: 'school-outline', text: 'Ich bin Lehrer' },
    { icon: 'account-tie-outline', text: 'Ich bin Schulleiter' },
    { icon: 'account-group-outline', text: 'Ich bin Teil der Schulverwaltung' },
    { icon: 'book-education-outline', text: 'Ich bin in der Ausbildung' },
    { icon: 'account-outline', text: 'Sonstiges' },
  ];
