...
export declare class Clerk implements ClerkInterface {
    ...
    __experimental_mountPricingTable: (node: HTMLDivElement, props?: __experimental_PricingTableProps) => void;
    __experimental_unmountPricingTable: (node: HTMLDivElement) => void;
    /**
     * `setActive` can be used to set the active session and/or organization.
     */
    setActive: ({ session, organization, beforeEmit, redirectUrl }: SetActiveParams) => Promise<void>;
    __experimental_nextTask: ({ redirectUrlComplete }?: NextTaskParams) => Promise<void>;
