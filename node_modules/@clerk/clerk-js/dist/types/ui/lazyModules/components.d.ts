...
export declare const ClerkComponents: {
    ...
    PricingTable: import("react").LazyExoticComponent<(props: import("@clerk/types").__experimental_PricingTableProps) => import("@emotion/react/jsx-runtime").JSX.Element>;
};
