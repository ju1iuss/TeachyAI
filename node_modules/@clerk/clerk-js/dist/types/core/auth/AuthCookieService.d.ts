...
export declare class AuthCookieService {
    ...
    private activeOrgCookie;
    private devBrowser;
    private sessionRefreshOfflineScheduler;
    static create(clerk: Clerk, fapiClient: FapiClient, instanceType: InstanceType): Promise<AuthCookieService>;
    private constructor();
    setup(): Promise<void>;
    isSignedOut(): boolean;
